...
Launches dvc with c/ 3rd-party apps disabled, allowing diagnosis of app related conflicts. Use to test if misbehaving apps are causing freezes, crashes, or battery drain.
