...
*Example: For a digital photo, the metadata includes the camera model, date and time of capture, file size, and resolution — details about the image that do not compose the picture itself, but are part of its history.*
