...
| Copy files                          | `copy`     | `cp`     |
| Copy directories and subdirectories | `xcopy`    | `rsynch` |
| Robust file transfers               | `robocopy` | `rsynch` |
| Move files                          | `move`     | `mv`     |
| Rename files                        | `ren`      | `mv`     |
| Display file contents               | `type`     | `cat`    |
| Delete files                        | `del`      | `rm`     |
| Grants administrative priviledge    | —          | `sudo`   |
...
| Scan disk for logical and physical errors | `chkdsk`          | `fsck`         |
| Disk partitioning                         | `diskpart`        | `fdisk`        |
